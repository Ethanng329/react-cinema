  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Displaybody2.default, {
...
var Movie = function (_React$Component) {
  ...
  _createClass(Movie, [{
    ...
    value: function handleClick(event) {
      ...
      fetch("https://www.omdbapi.com/?i=" + this.props.image.imdbID + "&apikey=db96ccd2").then(function (response) {
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch('/OMDB/' + this.state.input).then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log('movies', data);
        var movies = data.Search.map(function (item) {
          return item;
        });
        _this2.props.jsonReceiver(movies);
      }).catch(function (err) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.handleSubmit, className: 'searchfield' },
          _react2.default.createElement(
            'h1',
            null,
