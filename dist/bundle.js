...
var _Displaybody = __webpack_require__(/*! ./Displaybody */ "./src/Displaybody.js");

var _Displaybody2 = _interopRequireDefault(_Displaybody);

var _Plot = __webpack_require__(/*! ./Plot */ "./src/Plot.js");
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.jsonReceiver = _this.jsonReceiver.bind(_this);
    _this.plotReceiver = _this.plotReceiver.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'jsonReceiver',
    value: function jsonReceiver(data) {
      this.setState({
        movies: data
    ...
    key: 'plotReceiver',
    value: function plotReceiver(plot) {
      this.setState({
        plot: plot
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Search2.default, { jsonReceiver: this.jsonReceiver }),
        _react2.default.createElement(_Displaybody2.default, { movies: this.state.movies, plotReceiver: this.plotReceiver }),
        _react2.default.createElement(_Plot2.default, { plot: this.state.plot })
      );
    }
  }]);
...
var _Movie = __webpack_require__(/*! ./Movie */ "./src/Movie.js");
...
var Displaybody = function (_React$Component) {
  _inherits(Displaybody, _React$Component);

  function Displaybody(props) {
    _classCallCheck(this, Displaybody);

    var _this = _possibleConstructorReturn(this, (Displaybody.__proto__ || Object.getPrototypeOf(Displaybody)).call(this, props));
  ...
  _createClass(Displaybody, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        { className: 'resultDisplay', id: 'displayresult' },
        this.props.movies.map(function (movie) {
          return _react2.default.createElement(_Movie2.default, { key: movie.imdbID, image: movie, plot: _this2.plotReceiver });
...
var Movie = function (_React$Component) {
  ...
  _createClass(Movie, [{
    ...
    value: function handleClick(event) {
      ...
      fetch("http://www.omdbapi.com/?i=" + this.props.image.imdbID + "&apikey=db96ccd2").then(function (response) {
        return response.json();
      }).then(function (data) {
        var plot = data.Plot;
        console.log(plot);
        _this2.props.plot(plot);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "a",
          { className: "item", href: "https://www.imdb.com/title/" + this.props.image.imdbID },
          _react2.default.createElement("img", { className: "img", src: this.props.image.Poster, alt: "" })
        ),
        _react2.default.createElement(
          "p",
          { onClick: this.handleClick, className: "item__name" },
          this.props.image.Title,
          " (",
          this.props.image.Year,
          ")"
        )
      );
    }
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch("http://www.omdbapi.com/?s=" + this.state.input + "&apikey=db96ccd2").then(function (response) {
        return response.json();
      }).then(function (data) {
        console.log(data);
        that.props.jsonReceiver(data.Search.map(function (item) {
          return item;
        }));
      }).catch(function (error) {
        console.log(error);
